...
export const storage = isBrowser() ? localStorage : {} 
...
export const appConfig = {
  ...
  chart              : 'mostPopular',
  defaultRegion      : storage.countryCode ? storage.countryCode : 'US',
  defaultCategoryId  : storage.categoryId ? storage.categoryId : 10,
  maxVideosToLoad    : 24,
  countryList        : [
